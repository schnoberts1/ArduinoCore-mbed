...
#define CLOCK_SOURCE                                                            USE_PLL_HSE_XTAL | USE_PLL_HSI                                                                   // set by target:GIGA
...
#define MBED_CONF_TARGET_I2C_TIMING_VALUE_ALGO                                  1                                                                                                // set by target:GIGA
...
#define MBED_CONF_TARGET_SYSTEM_POWER_SUPPLY                                    PWR_LDO_SUPPLY                                                                                   // set by target:GIGA
